from tempfile import mktemp, TemporaryFile, TemporaryDirectory, NamedTemporaryFile, mkstemp
...
def test_initialise_journal_config(input_mock: MagicMock) -> None:
    with TemporaryDirectory() as journal_directory:
        ...
        journal_config: JournalConfiguration = initialise_journal_config(configuration_file_path)
